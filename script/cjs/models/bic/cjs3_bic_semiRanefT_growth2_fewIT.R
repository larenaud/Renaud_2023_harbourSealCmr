...
load("data/mine/old/20211031_cmr_pup35.RData")
...
print(i)
 ...
 saveRDS(outlist,file=paste0('/Users/LimoilouARenaud/Documents/PostDocI/Projects/cmrSeal/output.nosync/data/cjs/bic/20221205/cjs3_bic_semiRanefTGrowth2_fewIT_3.rds'),compress = 'xz')
