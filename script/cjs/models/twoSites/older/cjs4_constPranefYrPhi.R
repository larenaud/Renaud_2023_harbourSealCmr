...
#saveRDS(outlist,file=paste0('/Users/LimoilouARenaud/Documents/PostDocI/Projects/cmrSeal/output/data/bic_cjs_Gab2.rds'),compress = 'xz')
saveRDS(outlist,file=paste0('~/projects/def-pelleti2/renl2702/phoques/outputs/cjs4_constPranefYrPhi_combined.rds'),compress = 'xz')
