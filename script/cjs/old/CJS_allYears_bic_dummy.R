...
newOut <- nimbleMCMC(
    ...
    WAIC=FALSE, # needs to be changed
    summary = TRUE,
...
saveRDS(outlist,file=paste0('~/projects/def-pelleti2/renl2702/phoques/outputs/bic_cjs_Gab2.rds'),compress = 'xz')
# save(outlist,file= "/Users/LimoilouARenaud/Documents/PostDocI/Projects/cmrSeal/output/data/fewIT_list.RData")
# 
