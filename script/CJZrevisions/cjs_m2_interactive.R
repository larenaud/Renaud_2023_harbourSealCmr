...
inits <- function() {
    list(
        ...
        betaYearAdd=c(NA,rnorm(15, 0, 1.5)),# 1st reference level is fixed in models, no init
...
saveRDS(newOut,file=paste0('~/projects/def-pelleti2/renl2702/phoques/outputs/202305061430_m2_interactionYrSite.rds'),compress = 'xz')
