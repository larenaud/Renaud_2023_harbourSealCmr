...
# write_rds(chainOut,file = '202304301647_m4.rds',compress = 'xz')

# change model name in rds object
saveRDS(chainOut,file=paste0('~/projects/def-pelleti2/renl2702/phoques/outputs/202305061158_m4.rds'),compress = 'xz')
