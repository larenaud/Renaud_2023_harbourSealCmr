...
#SBATCH --time=0-72:05           # time (DD-HH:MM)
#SBATCH --ntasks=2              # 12 core(CPU)
#SBATCH --job-name=jollySeber6M   # sensible name for the job
...
R CMD BATCH --no-save --no-restore superpop_metis_6_ranIndOldData.R
