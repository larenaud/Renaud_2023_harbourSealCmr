...
# model with fixed effect of time on p, phi and b

load("~/projects/def-pelleti2/renl2702/Phoques/20210608_cmr_pup35.RData")
#load("/Users/LimoilouARenaud/Documents/Scolarite/PostDocI/Phoque/Data/Mine/20210608_cmr_pup35.RData")
...
parameters <- c("psi", "p", "phi", "b", "Nsuper", "N", "B", "nu", "w", "z") # added w and z to WAIC
...
for(i in 1:length(dflist)){
  ...
  write_rds(newOut,file=paste0('bic_superpop3_',years[i],'.rds'))
  rm(newOut,data)
}
dur=Sys.time()-start
