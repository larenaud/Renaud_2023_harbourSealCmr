...
load("/Users/LimoilouARenaud/Documents/PostDocI/Phoque/Data/Mine/20210608_cmr_pup35.RData")
...
parameters <- c("psi", "mean.p", "mean.phi", "b", "Nsuper", "N", "B", "nu", "w", "z") # added w and z to WAIC
...
for(i in 1:length(dflist)){
  ...
  newOut<-nimbleMCMC(
    ...
    write_rds(newOut,file=paste0('bic_superpop1_',years[i],'.rds'))
  rm(newOut,data)
}
dur=Sys.time()-start
